...
/* ARCHIFY:EXPORT_CLEANUP */
      ...
      function serializeSvg(scale, opts) {
        ...
        if (autoTheme) {
          ...
          style.textContent =
            fontCss + "\n" +
            "svg { font-family: 'Fira Code Nerd Font Mono', ui-monospace, SFMono-Regular, Menlo, Consolas, 'DejaVu Sans Mono', 'Liberation Mono', 'Noto Sans Mono CJK SC', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', monospace; }\n" +
            hostStyle + "\n" +
            ":root, svg { " + darkVars + " }\n" +
      ...
      function fitCanvasText(ctx, text, maxWidth, startSize, minSize, weight) {
        ...
        var size = startSize;
        var family = "'Fira Code Nerd Font Mono', ui-monospace, SFMono-Regular, Menlo, Consolas, monospace";
        while (size > minSize) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          img.onload = function () {
            try {
              ...
              ctx.font = "600 12px 'Fira Code Nerd Font Mono', ui-monospace, SFMono-Regular, Menlo, Consolas, monospace";
              ctx.textAlign = 'right';
              ctx.fillStyle = accent;
